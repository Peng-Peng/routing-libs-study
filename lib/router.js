(function(globals, RSVP, RouteRecognizer) {
    ...
    define("router/handler-info", ["./utils", "rsvp/promise", "exports"],
    ...
    define("router/handler-info/factory", ["router/handler-info/resolved-handler-info", "router/handler-info/unresolved-handler-info-by-object", "router/handler-info/unresolved-handler-info-by-param", "exports"],
    ...
    define("router/handler-info/resolved-handler-info", ["../handler-info", "router/utils", "rsvp/promise", "exports"],
        function(__dependency1__, __dependency2__, __dependency3__, __exports__) {
            "use strict";
    ...
    define("router/handler-info/unresolved-handler-info-by-object", ["../handler-info", "router/utils", "rsvp/promise", "exports"],
        function(__dependency1__, __dependency2__, __dependency3__, __exports__) {
            "use strict";
            var HandlerInfo = __dependency1__["default"];
    ...
    define("router/handler-info/unresolved-handler-info-by-param", ["../handler-info", "router/utils", "exports"],
        function(__dependency1__, __dependency2__, __exports__) {
            "use strict";
            var HandlerInfo = __dependency1__["default"];
    ...
    define("router/router", ["route-recognizer", "rsvp/promise", "./utils", "./transition-state", "./transition", "./transition-intent/named-transition-intent", "./transition-intent/url-transition-intent", "./handler-info", "exports"],
        function(__dependency1__, __dependency2__, __dependency3__, __dependency4__, __dependency5__, __dependency6__, __dependency7__, __dependency8__, __exports__) {
            ...
            function getTransitionByIntent(intent, isIntermediate) {
                ...
                console.log(wasTransitioning);
                console.log(oldState);
                console.log(newState);
                console.log(queryParamChangelist);
                ...
                newTransition.promise = newTransition.promise.then(function(result) {
                    console.log('newTrans promise resolved')
                    return finalizeTransition(newTransition, result.state);
                }, function(result) {
                    console.log('newTrans promise not resolved')
                ...
                */
                ...
                isActiveIntent: function(handlerName, contexts, queryParams, _state) {
                    var state = _state || this.state,
                        ...
                        found = false,
                        names, object, handlerInfo, handlerObj, i, len;
            ...
            */
            function handlerEnteredOrUpdated(currentHandlerInfos, handlerInfo, enter, transition) {
                ...
                if (handler.contextDidChange) callHook(handler, 'contextDidChange');
            ...
            */
            function partitionHandlers(oldState, newState) {
                ...
                var handlerChanged, contextChanged = false,
                    i, l;
    ...
    define("router/transition-intent", ["./utils", "exports"],
    ...
    define("router/transition-intent/named-transition-intent", ["../transition-intent", "../transition-state", "../handler-info/factory", "../utils", "exports"],
    ...
    define("router/transition-intent/url-transition-intent", ["../transition-intent", "../transition-state", "../handler-info/factory", "../utils", "exports"],
        function(__dependency1__, __dependency2__, __dependency3__, __dependency4__, __exports__) {
            "use strict";
            var TransitionIntent = __dependency1__["default"];
            var TransitionState = __dependency2__["default"];
    ...
    define("router/transition-state", ["./handler-info", "./utils", "rsvp/promise", "exports"],
        function(__dependency1__, __dependency2__, __dependency3__, __exports__) {
            "use strict";
    ...
    define("router/transition", ["rsvp/promise", "./handler-info", "./utils", "exports"],
        function(__dependency1__, __dependency2__, __dependency3__, __exports__) {
            "use strict";
    ...
    define("router/utils", ["exports"],
        function(__exports__) {
            ...
            if (!Array.isArray) {
                _isArray = function(x) {
                    console.log('1949 toString.call')
            ...
            **/
            function extractQueryParams(array) {
                ...
                if (len && len > 0 && array[len - 1] && array[len - 1].hasOwnProperty('queryParams')) {
                    ...
                    console.log('passed extractQuery Params slice.call')
            ...
            function subclass(parentConstructor, proto) {
                function C(props) {
                    ...
                    console.log('passed parentConstructor.call')
                }
            ...
            function resolveHook(obj, hookName) {
                ...
                console.log('resolveHook:' + hookName)
                console.log(obj)
                var underscored = "_" + hookName;
                console.log(obj[underscored] && underscored)
                console.log(obj[hookName] && hookName)
            ...
            function callHook(obj, _hookName, arg1, arg2) {
                ...
                console.log('_hookName=' + _hookName)
            ...
            function applyHook(obj, _hookName, args) {
                ...
                if (hookName) {
                    if (args.length === 0) {
                        ...
                        console.log('in applyHook ' + hookName);
    ...
    define("router", ["./router/router", "exports"],
        function(__dependency1__, __exports__) {
            "use strict";
